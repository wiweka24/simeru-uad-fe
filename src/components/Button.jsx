...
export default function Button({ text, linkto, color, color1, ...buttonProps }) {
  const border = {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={`absolute w-64 h-0 transition-all duration-100 ${bg[color1 || color]} top-1/2 origin-center rotate-45 -translate-x-20 group-hover:h-64 group-hover:-translate-y-32 ease`}
        />
        <span
