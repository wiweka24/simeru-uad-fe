...
import TableLecturerCredits from '../components/TableLecturerCredits'
import TableLecturerPlot from '../components/TableLecturerPlot'


export default function LecturerCourse() {
  return (
    <div className="grid grid-cols-6 m-10 gap-5">
      <div className=" border-2 rounded-lg bg-white col-span-4"> 
        <TableLecturerPlot/>
      </div>
